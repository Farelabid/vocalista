            ...
            <div className="flex flex-wrap gap-3 sm:gap-4 justify-center lg:justify-start">
              ...
              <div className="flex items-center gap-3 px-4 sm:px-5 lg:px-6 py-3 sm:py-4 bg-white rounded-2xl border-2 border-neutral-200 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <div>
                  ...
                  <div className="text-xs font-bold text-neutral-500 hidden sm:block">Beli Sekali, Akses Selamanya</div>
                  <div className="text-xs font-bold text-neutral-500 sm:hidden">Akses Selamanya</div>
                </div>
              </div>
          ...
          {courses.length > 0 ? (
            <>
              ...
              <div className="mb-10 sm:mb-12 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                <div>
                  <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-neutral-900 mb-2">Semua Courses</h2>
                ...
                <select
                  className="px-5 sm:px-6 py-3 bg-white text-neutral-900 text-sm font-bold rounded-xl border-2 border-neutral-200 focus:outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all cursor-pointer shadow-lg hover:shadow-xl hover:border-neutral-300"
              ...
              {/* CTA Banner - Accessible & Responsive */}
              <div className="mt-16 sm:mt-20 relative p-8 sm:p-10 lg:p-16 bg-gradient-to-br from-blue-600 via-blue-500 to-purple-600 rounded-2xl sm:rounded-3xl text-white overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10 max-w-3xl mx-auto text-center space-y-5 sm:space-y-6">
                  ...
                  <h3 className="text-2xl sm:text-3xl lg:text-4xl font-black">Butuh Bantuan Memilih?</h3>
                  ...
                  <button
                    className="inline-flex items-center gap-3 px-6 sm:px-8 py-4 sm:py-5 bg-white text-blue-600 font-black text-base sm:text-lg rounded-2xl hover:bg-blue-50 shadow-2xl hover:shadow-white/20 transition-all hover:scale-105 focus:outline-none focus:ring-4 focus:ring-white/50 focus:ring-offset-4 focus:ring-offset-blue-600 mt-4"
            ...
            /* Empty State - Accessible & Responsive */
            <div className="text-center py-24 sm:py-32 animate-scale-in">
              ...
              <Link
                href="/"
                className="inline-flex items-center gap-3 px-8 sm:px-10 py-4 sm:py-5 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-base sm:text-lg font-black rounded-2xl hover:from-blue-700 hover:to-purple-700 shadow-2xl hover:shadow-blue-500/40 transition-all hover:scale-105 focus:outline-none focus:ring-4 focus:ring-blue-500/50 focus:ring-offset-2"
              >
                <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <footer className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-neutral-900 text-white">
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="text-xl sm:text-2xl font-black">Radio Online Academy</span>
          </div>
