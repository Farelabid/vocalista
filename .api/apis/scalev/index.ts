...
class SDK {
   ...
   * @throws FetchError<400, types.ScalevApiWebBusinessGlobalControllerGetEnabledEpaymentsResponse400> Bad Request
   * @throws FetchError<401, types.ScalevApiWebBusinessGlobalControllerGetEnabledEpaymentsResponse401> Unauthorized
   * @throws FetchError<403, types.ScalevApiWebBusinessGlobalControllerGetEnabledEpaymentsResponse403> Forbidden
   * @throws FetchError<404, types.ScalevApiWebBusinessGlobalControllerGetEnabledEpaymentsResponse404> Not Found
   */
  scalevApiWebBusinessGlobalControllerGet_enabled_epayments(): Promise<FetchResponse<200, types.ScalevApiWebBusinessGlobalControllerGetEnabledEpaymentsResponse200>> {
   ...
   * @throws FetchError<400, types.ScalevApiWebProductControllerCreateDigitalProductFileResponse400> Bad Request
   * @throws FetchError<401, types.ScalevApiWebProductControllerCreateDigitalProductFileResponse401> Unauthorized
   * @throws FetchError<403, types.ScalevApiWebProductControllerCreateDigitalProductFileResponse403> Forbidden
   * @throws FetchError<404, types.ScalevApiWebProductControllerCreateDigitalProductFileResponse404> Not Found
   */
  scalevApiWebProductControllerCreate_digital_product_file(body: types.ScalevApiWebProductControllerCreateDigitalProductFileBodyParam, metadata: types.ScalevApiWebProductControllerCreateDigitalProductFileMetadataParam): Promise<FetchResponse<200, types.ScalevApiWebProductControllerCreateDigitalProductFileResponse200>>;
  scalevApiWebProductControllerCreate_digital_product_file(metadata: types.ScalevApiWebProductControllerCreateDigitalProductFileMetadataParam): Promise<FetchResponse<200, types.ScalevApiWebProductControllerCreateDigitalProductFileResponse200>>;
  scalevApiWebProductControllerCreate_digital_product_file(body?: types.ScalevApiWebProductControllerCreateDigitalProductFileBodyParam | types.ScalevApiWebProductControllerCreateDigitalProductFileMetadataParam, metadata?: types.ScalevApiWebProductControllerCreateDigitalProductFileMetadataParam): Promise<FetchResponse<200, types.ScalevApiWebProductControllerCreateDigitalProductFileResponse200>> {
    return this.core.fetch('/v2/variants/{variant_id}/digital-product-files', 'post', body, metadata);
  }
